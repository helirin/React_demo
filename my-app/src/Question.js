    ...
    render() {
        ...
        for (let index = 0; index < this.state.questions.length; index++) {
            ...
            //this.setState({oikein: quest.answer});                       //& index<10
                ...
                <input type="submit" value="Vastaa" className="submit"/>  
                </form>
                <br/>
                ...
                list.push(<b>Kilpailu päättyi. Kiitos osallistumisesta, sait {this.state.count} pistettä</b>)
            }
